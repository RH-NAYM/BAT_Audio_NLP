...
# Patterns
patterns = {
    'smoker': r"(sm.k.r|s.m.k.r|sm...r)",
    'dhumpai': r"(d.m.a.|d..mp..|.om.a.|umpa.|da.or.|de.m.|dhum...|dhu.a.)",
    'alchemy': r"(al.k.m|.lch.m.|alk..|al.a.)",
    'benson': r"(..ns.n|b.ch.n|.en..n|b.nso.)",
    'goldleaf': r"(go.lb|gol..lea.|g.l...|g.l..|....leaf)",
    'dunhil': r"(d.n.h.l|d.nh.l|.an.i.l|.an.i.l|dan.l|d.ni.l|d..nhil|danh..l)",
    'smooth': r"(.m..th|sm.d|.sm.t.)",
    'thanda_flvr': r"(th.nd..fl.v|t.nd...fl.v|th.nd...fl.v|t.nd..fl.v|..de.fl.v|.and..fl.v|..anda.fl..|.....flav|thund..fla.)",
    'best_tobacco': r"(.est.t.b..|.est..a.o|.est.o.a.o|.est.o.|bas....oba..|best.....ako|best.to.bak.)"
}
